...
def parse_args():
    ...
    interval.add_argument('--thread_id', dest='thread_id', type=int, help="binlog event thread_id", default=0)
...
def concat_sql_from_binlog_event(cursor, binlog_event, row=None, e_start_pos=None, flashback=False, no_pk=False, thread_id=0):
